 ...
 *  как `END_OF_DAY` («24:00») — внутреннее представление диапазона
 *  (единственное, которое понимает `<input type="time">`) не имеет права
 *  утечь читателю: сохранённая неделя и так хранит настоящее «24:00»
